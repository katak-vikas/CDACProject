...
public class JustTest2DebitCardNumberGenerator {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        String debitCardNumber = generateDebitCardNumber();
        System.out.println("Generated Debit Card Number: " + debitCardNumber);
        System.out.println(debitCardNumber.length());
    }
}
